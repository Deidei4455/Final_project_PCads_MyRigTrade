...
class CpuAdmin(admin.ModelAdmin):
    """
    Admin class for CPUs in admin page
    to be displayed.
    """
...
class GpuAdmin(admin.ModelAdmin):
    """
    Admin class for GPUs in admin page
    to be displayed.
    """
...
class PsuAdmin(admin.ModelAdmin):
    """
    Admin class for PSUs in admin page
    to be displayed.
    """
...
class RamAdmin(admin.ModelAdmin):
    """
    Admin class for RAMs in admin page
    to be displayed.
    """
...
class StorageAdmin(admin.ModelAdmin):
    """
    Admin class for storages in admin page
    to be displayed.
    """
...
class CasePCAdmin(admin.ModelAdmin):
    """
    Admin class for PC cases in admin page
    to be displayed.
    """
...
class MotherboardAdmin(admin.ModelAdmin):
    """
    Admin class for motherboards in admin page
    to be displayed.
    """
...
class CpuCoolerAdmin(admin.ModelAdmin):
    """
    Admin class for CPU coolers in admin page
    to be displayed.
    """
